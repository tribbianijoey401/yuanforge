...
| **活跃 Agent** | task-005 r1 已完成；task-006 等待 Tester 独立重绑定与复测 |
...
| task-005 | 1 | M3 28-check held-out 中 12 FAIL；r1 已封闭 B01–B05，等待 Tester 独立重绑定与复测 | Tester |
