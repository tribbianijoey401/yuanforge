...
| **活跃 Agent** | 无；task-003 r2 已修复，下一任务 task-004 复测 |
...
| task-003 | P0 | R0 | M1 实现 bootstrap verifier | backend-dev | task-002 | ✅ 完成（r2 待复测） | `scripts/bootstrap-core-verifier.py`, `scripts/bootstrap_verifier*.py`, `tests/bootstrap_verifier/` | `evidence/m1/held-out-r1-pre-fix.json` |
