...
| **活跃 Agent** | 无；M1 已通过，下一任务 task-005 |
...
| task-005 | P0 | R0 | M2 实现 inert Core candidate | backend-dev | task-004 | 🟢 就绪 | `.yuan/core/0.1/` | `DESIGN.md#2-五个-core-原语` |
