...
| **活跃 Agent** | task-005 Backend Dev 已完成 author 实现；task-006 等待独立 Tester |
...
| task-005 | P0 | R0 | M2 实现 inert Core candidate | backend-dev | task-004 | ✅ 完成 | `.yuan/core/0.1/`, `evidence/m2/` | `evidence/m2/author-final.json` |
| task-006 | P0 | R0 | M3 旧信任根验证新候选 | tester | task-005 | 🟢 就绪 | conformance Evidence | `DESIGN.md#8-trust-root-与验证层` |
