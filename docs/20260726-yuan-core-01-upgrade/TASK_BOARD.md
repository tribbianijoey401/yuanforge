...
| **活跃 Agent** | task-008 已完成；task-009 与 task-010 可由 Conductor 继续派发 |
...
| task-009 | P1 | R1 | M6 Adapter conformance | tester | task-008 | 🟢 就绪 | adapter reports | `DESIGN.md#7-最小平台-port` |
