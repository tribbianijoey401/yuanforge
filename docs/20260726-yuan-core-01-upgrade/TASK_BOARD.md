...
| **活跃 Agent** | task-006 r1 复测发现 M3-B06；task-005 等待 Backend Dev r2 |
...
| task-005 | P0 | R0 | M2 实现 inert Core candidate | backend-dev | task-004 | 🔄 返工 r2 | `.yuan/core/0.1/`, `evidence/m2/` | `evidence/m3/independent-review.md` |
...
| task-005 | 2 | r1 封闭 B01–B05；独立复测新增纯数据组合检查发现 B06，进入 r2 | Tester |
