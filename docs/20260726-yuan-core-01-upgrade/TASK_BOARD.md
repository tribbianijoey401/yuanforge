...
| task-003 | P0 | R0 | M1 实现 bootstrap verifier | backend-dev | task-002 | 🟢 就绪 | bootstrap verifier | `PLAN.md#里程碑-gate` |
| task-004 | P0 | R0 | M1 负向 fixtures 与反作弊验证 | tester | task-003 | ⏳ 等待 | negative fixtures, receipt | `FEATURE.md#clean-room-验收标准` |
