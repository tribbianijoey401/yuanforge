...
每次 Loop 执行 7 步（L1 级，与 L0 合并为一份权威循环）：
...
# REMOVED <SECTION-END> marker: <SECTION-END:conductor-schedule>
...
# REMOVED <SECTION-END> marker: <SECTION-END:conductor-tier>
...
---
# REMOVED <SECTION-END> marker: <SECTION-END:conductor-forbidden>
...
# REMOVED <SECTION-END> marker: <SECTION-END:conductor-exit>
...
```markdown
# REMOVED <SECTION-END> marker: <SECTION-END:conductor-session-log>
