...
> 修复回路/审查修正路由表的权威定义见 `_shared.md`。本合约仅保留触发条件说明。

| 触发条件 | 说明 |
|---------|------|
| Tester 🟡 Hard Gate 失败 | 按 `_shared.md` 路由表分发 |
| 审查官 🔴 Blocker 打回 | 按 `_shared.md` 路由表分发 |
