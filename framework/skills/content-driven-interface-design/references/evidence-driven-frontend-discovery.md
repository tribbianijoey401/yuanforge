...
本 Reference 用于高影响 UI、新产品、重要改版、数据密集界面，或用户明确反馈现有界面“普通、简单、不流畅、缺少高级感”时。它把需求研究、Repository 事实与 prototype convergence 连接起来；不规定固定访谈轮数，也不预设亮色、暗色、Dashboard 或任何行业视觉配方。
