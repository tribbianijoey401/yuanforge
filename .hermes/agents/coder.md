...
**必须加载：**
- [ ] Plan 中当前 Task 的完整描述
- [ ] `docs/features/NNN-xxx.md` — 当前功能的 Feature 文档
...
更新 `docs/features/NNN-xxx.md` 中「修改的文件」表：
...
| 文档 | 操作 | 时机 |
|------|------|------|
| `docs/features/NNN-xxx.md` | **更新「修改文件」表** | 每个 Task 完成后 |
| `docs/bugs/BUG-NNN-xxx.md` | **创建** | 实现中发现 Bug 时（记录现象，根因留给 Debugger） |

### 参阅

| 文档 | 时机 |
|------|------|
| `docs/features/NNN-xxx.md` | 理解当前功能设计 |
...
### 文档已更新
- [ ] `docs/features/{NNN}-{name}.md` — 修改文件表已更新
```
