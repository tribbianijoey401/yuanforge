...
> **Status:** legacy protocol smoke benchmark  
> **Role:** evaluation asset, not a Yuan Framework runtime asset  
> **Authority:** not the authoritative Artifact Quality benchmark

This benchmark is retained for historical and protocol-validation value. It validates the early comparison protocol around Bare Agent / Current Yuan / Quality Yuan, but it is not part of the canonical `framework/` runtime and must not be used as the authoritative measure of Yuan Artifact Quality.
