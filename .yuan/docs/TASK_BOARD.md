...
|----|----|------|------|------|-----------|------|------|
| T01 | P2 | [任务名] | [architect/coder/reviewer/tester/devops] | [-] | [默认见下表] | [状态] | [文件路径] |
...
任意阶段 — 取消:
  ...
  ▼
Conductor 收尾:
  1. 全部任务处于终态 → 填 SESSION_LOG「任务完成情况」→ 更新 SESSION_LOG.md
  2. 有非终态任务 → 填 SESSION_LOG → PROGRESS.md 标记「未完成，续接至下一会话」
