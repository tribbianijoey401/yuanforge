...
- [ ] `.yuan/docs/GLOBAL.md` + `.yuan/docs/SESSION.md` — 文档规范
...
选型产出：
- 技术栈表（语言、框架、数据库）
- 每个选型创建 当前会话文件夹中的 ADR-NNN-xxx.md
...
| 当前会话文件夹中的 FEATURE.md | **创建 + 填设计** | 新功能启动时创建，填「需求描述」「设计思路」「关联文档」 |
| 当前会话文件夹中的 ADR-NNN-xxx.md | **创建** | 每次技术选型时创建，填完整 ADR |

### 参阅

| 文档 | 时机 |
|------|------|
| 当前会话文件夹中的已有决策 | 选型前避免重复决策 |
...
### 文档产出
- 📦 Feature: 当前会话文件夹中的 FEATURE.md
- 📋 决策: 当前会话文件夹中的 ADR-{NNN}-{name}.md
